...
class MainWindow(QMainWindow):
    ...
    def create_controls(self):
        ...
        self.battery_label.setPixmap(
            QPixmap("bat_full.png").scaledToHeight(100))
        self.battery_label.setFixedSize(100, 100)
        ...
        self.additional_icon_label.setPixmap(
            QPixmap("logo_melan.png").scaledToHeight(200))
        ...
        # Tambahkan tombol shutdown dengan ikon di bawah slider zoom
        self.shutdown_button = QPushButton()
        # Ganti dengan path ikon Anda
        self.shutdown_button.setIcon(QIcon("power.png"))
        self.shutdown_button.setIconSize(QSize(100, 100))  # Ukuran ikon
        self.shutdown_button.setFixedSize(120, 120)  # Ukuran tombol
    ...
    def create_slider(self, icon_path, label_text, slot, min_value, max_value, default_value):
        ...
        minus_button.clicked.connect(
            lambda: slider.setValue(slider.value() - 1))
        ...
        # QLabel to show slider value
        value_label = QLabel()
        value_label.setAlignment(Qt.AlignCenter)
        value_label.setNum(slider.value())
        layout.addWidget(value_label)

        # Connect the slider's valueChanged signal to the QLabel's setNum slot
    ...
    def confirm_shutdown(self):
        reply = QMessageBox.question(
            self, 'MELANVEER', 'do you want to turn off melanveer?', QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
    ...
    def shutdown(self):
        ...
        if operating_system == "Windows":
            ...
            QMessageBox.warning(
                self, 'Error', 'Sistem operasi tidak didukung!')
